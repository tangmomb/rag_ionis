...
class IonisStmCorrectionTests(unittest.TestCase):
    def test_known_ionis_stm_variants_are_normalized(self):
        ...
        result = correction.correct_text(
            "IONIS STM, yonis stm, l'ionis stm, ionis stm, yaunis stm, "
            "UNISSTM, Unisystem et IonisSTM.",
            {}, {}, {}, {}, correction.correction_settings("balanced"), corrections,
        )

        self.assertEqual(
            result,
            "Ionis-STM, Ionis-STM, Ionis-STM, Ionis-STM, Ionis-STM, "
            "Ionis-STM, Ionis-STM et Ionis-STM.",
        )
        self.assertEqual(corrections["l'ionis stm"], {"Ionis-STM"})
        self.assertEqual(corrections["UNISSTM"], {"Ionis-STM"})
        self.assertEqual(corrections["Unisystem"], {"Ionis-STM"})
        self.assertEqual(corrections["IonisSTM"], {"Ionis-STM"})
