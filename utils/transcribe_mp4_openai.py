...
TEXT_SUFFIX = "_openai_whisper_transcript.txt"
...
def prompt_model_choice():
    ...
    prompt = "Choisis un numero de modele (defaut: 1): "
    while True:
...
def write_outputs(video_path, payload, model_option):
    ...
    text_path = OUTPUT_DIR / f"{video_path.stem}{TEXT_SUFFIX}"
...
def main():
    ...
    model_option = prompt_model_choice()
